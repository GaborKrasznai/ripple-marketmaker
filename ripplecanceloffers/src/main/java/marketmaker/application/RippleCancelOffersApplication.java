...
public class RippleCancelOffersApplication extends BaseRippleClient {
	private static Logger log = LoggerFactory.getLogger(RippleCancelOffersApplication.class);
	...
	public static void main(String[] args) throws IOException {
		SpringApplication.run(RippleCancelOffersApplication.class, args);
	}
}
