...
public class RippexLiquidityMakerApplication extends BaseRippleClient {
	private static Logger log = LoggerFactory.getLogger(RippexLiquidityMakerApplication.class);
	...
	public static void main(String[] args) throws IOException {
		SpringApplication.run(RippexLiquidityMakerApplication.class, args);
	}
}
